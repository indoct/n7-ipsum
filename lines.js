...
lines[207] = { char: "Wrex", line: "That's why I love hanging out with you guys! Why shoot something once when you can shoot it 46 more times? " };
lines[208] = { char: "Shepard", line: "I'm only slow because I'm not running! " };
lines[209] = {
  char: "Wrex",
...
lines[246] = {
  char: "TIM",
  line: "You're making a habit of costing me more than time and money. ",
};
lines[247] = {
  char: "Shepard",
...
lines[341] = {
  char: "Kaidan",
  line: "Mom was right, I should've brought a sweater. ",
};
lines[342] = {
  char: "Kaidan",
  line: "Did I ever tell you about my casino run-in with the Vorcha mafia, 5000 credits and a bottle of whiskey? Actually, never mind. ",
};
lines[343] = {
  char: "Kaidan",
  line: "We have, uh, beef... We have bacon... we have beer. The foods of my people! ",
};
lines[344] = {
  char: "Kaidan",
  line: "Mike Hazer? Hazer the Laser?! I almost didn't recognize you! You owe me money. ",
};
lines[345] = {
  char: "Kaidan",
  line: "Fifty thousand years to figure this out and it’s down to twenty-five mutineers. Way to go, Team Milky Way. ",
};
lines[346] = {
  char: "Kaidan",
  line: "I think we're gonna need a bigger boot, Commander. ",
};
lines[347] = {
  char: "Kaidan",
  line: "Comrades in arms. We know the score. We know this is goodbye. ",
};
lines[348] = {
  char: "Kaidan",
  line: "Big place. ",
